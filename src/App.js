...
import RequestUser from './components/RequestUser';  // Importa el componente RequestUser
...
import Informes from './components/Informes';  // Importa el componente Informes
import IndicadoresCACCancer from './components/IndicadoresCACCancer';  // Importa el componente IndicadoresCACCancer
import CancerActual from './components/CancerActual';  // Importa el componente CancerActual
import Alertas from './components/Alertas';  // Importa el componente Alertas
    ...
    <Router>  {/* El componente Router envuelve toda la aplicación para habilitar el enrutamiento */}
      <div className="app">  {/* Contenedor principal de la aplicación con clase 'app' */}
        <Routes>  {/* Componente Routes que se encarga de gestionar las rutas de la aplicación */}
          ...
          {/* Rutas públicas */}
          <Route path="/" element={<Login />} />  {/* Ruta pública para la página de login */}
          ...
          <Route path="/home" element={<AuthenticatedLayout />}>  {/* Ruta para el Home que está protegida por autenticación */}
            ...
            <Route path="/home/informes" element={<Informes />} />  {/* Subruta para Informes dentro del layout protegido */}
            <Route path="/home/indicadores-cac-cancer" element={<IndicadoresCACCancer />} />  {/* Subruta para IndicadoresCACCancer dentro del layout protegido */}
            <Route path="/home/cancer-actual" element={<CancerActual />} />  {/* Subruta para CancerActual dentro del layout protegido */}
            <Route path="/home/alertas" element={<Alertas />} />  {/* Subruta para Alertas dentro del layout protegido */}
          </Route>
